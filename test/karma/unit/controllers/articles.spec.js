...
(function() {
	...
	describe('<Controllers> \n', function() {
		describe('ArticlesController', function() {
			...
			it('$scope.find() should create an array with at least one article object', function() {

					// test expected GET request
					$httpBackend.expectGET('api/articles').respond([{
						title: 'An Article about Octobox',
			...
			it('$scope.findOne() should create an article array fetched with a URL parameter', function() {
			...
			it('$scope.create() should send a POST request with the form values and go to new URL', function() {
					...
					scope.title = 'An Article about Octobox';
					scope.content = 'Octobox rocks!';
			...
			it('$scope.update() should update a valid article', inject(function(Articles) {
				...
				/*
				Error: Expected PUT /api/articles\/([0-9a-fA-F]{24})$/ with different data
				EXPECTED: {"_id":"525a8422f6d0f87f0e407a33","title":"An Article about Octobox","to":"Octobox is great!"}
				GOT:		{"_id":"525a8422f6d0f87f0e407a33","title":"An Article about Octobox","to":"Octobox is great!","updated":[1383534772975]}
				*/
			...
			it('$scope.remove() should send a valid DELETE request and remove the article \n', inject(function(Articles) {
